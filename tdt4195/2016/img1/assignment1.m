...
% The weighted conversion is more appealing and less muted than the averaged one.
...
%% Task 3
% Kernels
gauss = 1/256*[1 4 6 4 1; 4 16 24 16 4; 6 24 36 24 6; 4 16 24 16 4; 1 4 6 4 1];
avg = 1/9 * ones(3);

% See conv3.m for the convolution function
